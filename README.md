# Задания и вариант решения 2 этапа конкурса "Администрирование Linux" IT-планеты в 2018 году
...
IP-адрес можно получать динамически, прямо в конфиге прописав шелловый пайплайн.
...
Данное решение было оценено на 44 балла из 50, что в принципе справедливо.
