...
* первый этап, ответы на теоретические вопросы разной сложности (20-30 штук), вопросы разные, начиная от "Кто является владельцем торговой марки Linux?" и заканчивая ACL-ками в squid и маршрутизацией трафика в IPTables, кстати они довольно нечасто обновляются, часть вопросов еще в 2012 были, точно помню
...
* задание 2 этапа (вроде заочное, точно не помню) в 2014 году: https://blog.amet13.name/2014/03/linux-it-19032014.html
...
Далее добавляем юзера `koshkanorm` в группу `mothyabrodsky`, чтобы он мог иметь доступ к файлам нужным и даем группе права `770` на каталог:
```
...
По скрипту можно было еще [шеллчеком](https://github.com/koalaman/shellcheck) пройтись, но это не обязательно.
...
Качаем исходники `nyancat` и устанавливаем:
```
...
* исправления --- Fork и Pull Request
* вопросы можно в Issue писать
* свои варианты решений тоже можете предложить в Pull Request
* вопросы наверное можно сюда задавать: https://t.me/contestlinux

Те кто дочитал до конца и прострелил себе ногу на правилах IPTables, может вам пригодится мой опыт: https://blog.amet13.name/2014/04/iptables.html
